...
export const DriverProfile = (props) => {
    ...
    async function initializer() {
        ...
        if (driver) {
            setFormValues({ firstname: driver.first_name, lastname: driver.last_name, email: driver.email_id, password: "", phone: driver.contact_number, dob: moment(driver.date_of_birth).utc().format('YYYY-MM-DD'), gender: driver.gender });
            setDriverEmail(driver.email_id);
        }
        setInitialised(true);
    }
